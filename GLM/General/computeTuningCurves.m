...
function [pos_curve, hd_curve, speed_curve, speedHD_curve] = computeTuningCurves(dataForLearning, features, config, spiketrain)
...
[speedHD_curve] = compute_1d_tuning_curve(features.speedHD, firingRate, config.numOfHDSpeedBins, 0, config.maxSpeed);
